 ...
 */
public class SimpleKMeansWithSilhouette extends RandomizableClusterer
	 ...
	 */
	public SimpleKMeansWithSilhouette() {
		super();
	 ...
	 * 
	 * @param slots
	 *            the number of tasks to run in parallel when computing the nearest
	 ...
	 */
	/*
	 * public static void main(String[] args) { runClusterer(new SimpleKMeans(),
	 * args); }
	 */
}
