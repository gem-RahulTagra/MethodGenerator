...
public class WekaClusterers {
	...
	/*
	 * private static Map<Integer, LinkedList<String>> printMap(Map<Integer,
	 * LinkedList<String>> map) { System.out.println("CLUSTERS"); for (Integer
	 * cluster : map.keySet()) { System.out.println("\t"+ cluster + "\t" +
	 * map.get(cluster)); } System.out.println(); return map; }
	 */
	 ...
	 * @throws IOException
	 */
	private static LinkedHashMap<Integer, LinkedList<String>> parseKMeansOutput(String s, String numClusters)
			throws IOException {
